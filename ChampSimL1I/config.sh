...
default_l1i  = { 'sets': 64, 'ways': 8, 'rq_size': 64, 'wq_size': 64, 'pq_size': 32, 'mshr_size': 8, 'latency': 4, 'max_read': 2, 'max_write': 2, 'prefetcher': 'no_l1i', 'replacement': 'lru_l1i' }
...
if config_file['L1I']['replacement'] is not None:
    libfilenames['l1ireplacement.a'] = 'replacement/' + config_file['L1I']['replacement']
