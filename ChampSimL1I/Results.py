...
new_prefetcher = input("What binary are you checking?\n")

trace_path = os.getenv("HOME")+'/InstructionPrefetchers-And-CacheReplacementPolicies/ChampSimL1I/ipc1_public'
traces = os.listdir(trace_path)
path = os.getenv("HOME")+'/InstructionPrefetchers-And-CacheReplacementPolicies/ChampSimL1I/results'
