...
//#define FNL_NBENTRIES (1<< (16+LOGMULTSIZE )) // 64K
#define FNL_NBENTRIES (1<< (14+LOGMULTSIZE )) // 16K
...
#define LOGWAYNEXTMISS (8 +LOGMULTSIZE)
#define SIZEWAYNEXTMISS (1 << LOGWAYNEXTMISS) // Size of each 8 ways on miss ahead prediction table becomes 256 entries (was 1024)
